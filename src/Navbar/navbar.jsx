        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <NavLink to="/" className={({isActive})=> isActive ? 'text-green-400 p-2 ring-1 ring-offset-2 rounded-lg ring-green-400' : ''}>Home</NavLink>
                    <NavLink to="/Listed Books" className={({isActive})=> isActive ? 'text-green-400 p-2 ring-1 ring-offset-2 rounded-lg ring-green-400' : ''}>Listed Books</NavLink>
                    <NavLink to="/Pages to Read" className={({isActive})=> isActive ? 'text-green-400 p-2 ring-1 ring-offset-2 rounded-lg ring-green-400' : ''}>Pages to Read</NavLink>
                    </div>
                </div>
                <Link to="/" className=" text-2xl font-bold lg:text-4xl">Book Vibe</Link>
            </div>
