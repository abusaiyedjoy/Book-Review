                ...
                <div className="flex flex-col p-4 divide-y  lg:p-6 dark:divide-gray-300">
                    ...
                    <div className="pt-6 pb-4 space-y-2">
                        <Link to={`/card Details/${bookId}`}
                            className="relative w-full inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-cyan-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:via-emerald-500">
